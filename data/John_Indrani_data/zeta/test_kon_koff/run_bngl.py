...
def run_bionetgen(n,p):
    ...
    for  i in range (0,n,1) :
          ret = bionetgen.run("zeta_HPC.bngl", out="HPC_output_"+str(i),suppress=True)
     
    #save the time,pZAP70 data from folder_0
    dir_X= "HPC_output_0"
    X = open(dir_X+'/zeta_HPC.gdat').readlines()   # X is a list with  \t
    l=len(X)
    t=[]
    ...
    for i in range (1,n,1) : #reading folders i=1,n
              ...
              X = open(dir_X+'/zeta_HPC.gdat').readlines()
