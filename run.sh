...
python3 main.py -i 'data/linear.csv' -h 100 --epochs 10 -d 2 -o 'l3p_norm_out' --normalize --normalize_out
...
python3 main.py -i 'data/gdag_1300ss.csv' -h 100 --epochs 100 -d 5 -o 'gdag1300n' --gpu --normalize
python3 main.py -i 'data/gdag_1300ss.csv' -h 100 --epochs 100 -d 5 -o 'gdag1300_n_out' --normalize --normalize_out
...
python3 main.py -i 'data/gdag_1300ss_covs.csv' -h 64 --epochs 100 -d 5 -o 'gdag1300_covs' --normalize --normalize_out